...
Bridge.assembly("UnityScriptsCompiler", function ($asm, globals) {
    ...
    /*AdaptiveCameraPosition start.*/
    Bridge.define("AdaptiveCameraPosition", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "AdaptiveCameraPosition#init", this ); }

                this._targetPosition = new UnityEngine.Vector3();
                this._targetRotation = new UnityEngine.Quaternion();
                this.transitionSpeed = 2.0;
                this.aspectRatioThreshold = 1.0;
        ...
        methods: {
            /*AdaptiveCameraPosition.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "AdaptiveCameraPosition#Awake", this ); }

                this._camera = this.GetComponent(UnityEngine.Camera);
                this._lastOrientation = UnityEngine.Screen.orientation;
                this.UpdateCameraMode(this.GetIsPortrait());
            },
            /*AdaptiveCameraPosition.Awake end.*/

            /*AdaptiveCameraPosition.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "AdaptiveCameraPosition#Update", this ); }

                var currentIsPortrait = this.GetIsPortrait();
                if (currentIsPortrait !== this._isPortrait || UnityEngine.Screen.orientation !== this._lastOrientation) {
                    if (this.debugMode) {
                        UnityEngine.Debug.Log$1("\u041e\u0440\u0438\u0435\u043d\u0442\u0430\u0446\u0438\u044f \u0438\u0437\u043c\u0435\u043d\u0438\u043b\u0430\u0441\u044c: " + ((currentIsPortrait ? "\u043f\u043e\u0440\u0442\u0440\u0435\u0442" : "\u043b\u0430\u043d\u0434\u0448\u0430\u0444\u0442") || "") + ", " + (System.String.format("\u0441\u043e\u043e\u0442\u043d\u043e\u0448\u0435\u043d\u0438\u0435 \u0441\u0442\u043e\u0440\u043e\u043d: {0}", [Bridge.box(UnityEngine.Screen.width / UnityEngine.Screen.height, System.Single, System.Single.format, System.Single.getHashCode)]) || ""));
                    }
                    this.UpdateCameraMode(currentIsPortrait);
                    this._lastOrientation = UnityEngine.Screen.orientation;
                }
                if (!this._isTransitioning) {
                    return;
                }
                this.transform.position = new pc.Vec3().lerp( this.transform.position, this._targetPosition, UnityEngine.Time.deltaTime * this.transitionSpeed );
                this.transform.rotation = new pc.Quat().slerp( this.transform.rotation, this._targetRotation, UnityEngine.Time.deltaTime * this.transitionSpeed );
                if (this._camera.orthographic) {
                    this._camera.orthographicSize = pc.math.lerp(this._camera.orthographicSize, this._targetOrthoSize, UnityEngine.Time.deltaTime * this.transitionSpeed);
                } else {
                    this._camera.fieldOfView = pc.math.lerp(this._camera.fieldOfView, this._targetFOV, UnityEngine.Time.deltaTime * this.transitionSpeed);
                }
                if (!(pc.Vec3.distance( this.transform.position, this._targetPosition ) < 0.01) || !(pc.Quat.angle( this.transform.rotation.$clone(), this._targetRotation.$clone() ) < 0.1)) {
                    return;
                }
                if (this._camera.orthographic) {
                    if (Math.abs(this._camera.orthographicSize - this._targetOrthoSize) < 0.01) {
                        this._isTransitioning = false;
                    }
                } else if (Math.abs(this._camera.fieldOfView - this._targetFOV) < 0.1) {
                    this._isTransitioning = false;
                }
            },
            /*AdaptiveCameraPosition.Update end.*/

            /*AdaptiveCameraPosition.GetIsPortrait start.*/
            GetIsPortrait: function () {
if ( TRACE ) { TRACE( "AdaptiveCameraPosition#GetIsPortrait", this ); }

                var aspectRatio = UnityEngine.Screen.width / UnityEngine.Screen.height;
                return aspectRatio < this.aspectRatioThreshold;
            },
            /*AdaptiveCameraPosition.GetIsPortrait end.*/

            /*AdaptiveCameraPosition.UpdateCameraMode start.*/
            UpdateCameraMode: function (isPortrait) {
if ( TRACE ) { TRACE( "AdaptiveCameraPosition#UpdateCameraMode", this ); }

                this._isPortrait = isPortrait;
                var settings = (isPortrait ? this.portraitSettings : this.landscapeSettings);
                this._targetPosition = settings.position.$clone();
                this._targetRotation = new pc.Quat().setFromEulerAngles_Unity( settings.rotation.x, settings.rotation.y, settings.rotation.z );
                this._targetOrthoSize = settings.orthographicSize;
                this._targetFOV = settings.fieldOfView;
                this._isTransitioning = true;
                if (this.debugMode) {
                    UnityEngine.Debug.Log$1("\u041f\u0435\u0440\u0435\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435 \u043d\u0430 " + ((isPortrait ? "\u043f\u043e\u0440\u0442\u0440\u0435\u0442\u043d\u044b\u0439" : "\u043b\u0430\u043d\u0434\u0448\u0430\u0444\u0442\u043d\u044b\u0439") || "") + " \u0440\u0435\u0436\u0438\u043c. " + (System.String.format("\u0426\u0435\u043b\u0435\u0432\u0430\u044f \u043f\u043e\u0437\u0438\u0446\u0438\u044f: {0}, \u041f\u043e\u0432\u043e\u0440\u043e\u0442: {1}", this._targetPosition.$clone(), settings.rotation.$clone()) || ""));
                }
            },
            /*AdaptiveCameraPosition.UpdateCameraMode end.*/

            /*AdaptiveCameraPosition.ForceUpdate start.*/
            ForceUpdate: function () {
if ( TRACE ) { TRACE( "AdaptiveCameraPosition#ForceUpdate", this ); }

                this.UpdateCameraMode(this.GetIsPortrait());
            },
            /*AdaptiveCameraPosition.ForceUpdate end.*/


        }
    });
    /*AdaptiveCameraPosition end.*/

    /*AdaptiveCameraPosition+CameraSettings start.*/
    Bridge.define("AdaptiveCameraPosition.CameraSettings", {
        $kind: 1002,
        fields: {
            position: null,
            rotation: null,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "AdaptiveCameraPosition.CameraSettings#init", this ); }
    ...
    /*AdaptiveCameraPosition+CameraSettings end.*/

    /*BalanceManager start.*/
    Bridge.define("BalanceManager", {
        inherits: [UnityEngine.MonoBehaviour],
        statics: {
            fields: {
                Instance: null
        ...
        props: {
            CurrentBalance: {
                get: function () {
if ( TRACE ) { TRACE( "BalanceManager#CurrentBalance#get", this ); }
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "BalanceManager#init", this ); }

                this._initialBalance = 100;
                this._debugLogs = true;
            }
        },
        methods: {
            /*BalanceManager.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "BalanceManager#Awake", this ); }

                if (UnityEngine.MonoBehaviour.op_Equality(BalanceManager.Instance, null)) {
                    BalanceManager.Instance = this;
                ...
                this._currentBalance = this._initialBalance;
            },
            /*BalanceManager.Awake end.*/

            /*BalanceManager.AddMoney start.*/
            AddMoney: function (amount) {
if ( TRACE ) { TRACE( "BalanceManager#AddMoney", this ); }

                if (amount <= 0) {
                    UnityEngine.Debug.LogWarning$1(System.String.format("<color=orange>[BalanceManager]</color> \u041f\u043e\u043f\u044b\u0442\u043a\u0430 \u0434\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u043e\u0442\u0440\u0438\u0446\u0430\u0442\u0435\u043b\u044c\u043d\u0443\u044e \u0438\u043b\u0438 \u043d\u0443\u043b\u0435\u0432\u0443\u044e \u0441\u0443\u043c\u043c\u0443: {0}", [Bridge.box(amount, System.Int32)]));
                    return this._currentBalance;
                }
                this._currentBalance = (this._currentBalance + amount) | 0;
                if (this._debugLogs) {
                    UnityEngine.Debug.Log$1(System.String.format("<color=green>[BalanceManager]</color> \u0414\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u043e ${0}. \u041d\u043e\u0432\u044b\u0439 \u0431\u0430\u043b\u0430\u043d\u0441: ${1}", Bridge.box(amount, System.Int32), Bridge.box(this._currentBalance, System.Int32)));
                }
                !Bridge.staticEquals(this.OnBalanceChanged, null) ? this.OnBalanceChanged(this._currentBalance) : null;
                return this._currentBalance;
            },
            /*BalanceManager.AddMoney end.*/

            /*BalanceManager.SpendMoney start.*/
            SpendMoney: function (amount) {
if ( TRACE ) { TRACE( "BalanceManager#SpendMoney", this ); }

                if (amount <= 0) {
                    UnityEngine.Debug.LogWarning$1(System.String.format("<color=orange>[BalanceManager]</color> \u041f\u043e\u043f\u044b\u0442\u043a\u0430 \u043f\u043e\u0442\u0440\u0430\u0442\u0438\u0442\u044c \u043e\u0442\u0440\u0438\u0446\u0430\u0442\u0435\u043b\u044c\u043d\u0443\u044e \u0438\u043b\u0438 \u043d\u0443\u043b\u0435\u0432\u0443\u044e \u0441\u0443\u043c\u043c\u0443: {0}", [Bridge.box(amount, System.Int32)]));
                    return false;
                }
                if (this._currentBalance < amount) {
                    if (this._debugLogs) {
                        UnityEngine.Debug.LogWarning$1(System.String.format("<color=orange>[BalanceManager]</color> \u041d\u0435\u0434\u043e\u0441\u0442\u0430\u0442\u043e\u0447\u043d\u043e \u0441\u0440\u0435\u0434\u0441\u0442\u0432. \u0422\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044f: ${0}, \u0414\u043e\u0441\u0442\u0443\u043f\u043d\u043e: ${1}", Bridge.box(amount, System.Int32), Bridge.box(this._currentBalance, System.Int32)));
                    }
                    return false;
                }
                this._currentBalance = (this._currentBalance - amount) | 0;
                if (this._debugLogs) {
                    UnityEngine.Debug.Log$1(System.String.format("<color=yellow>[BalanceManager]</color> \u041f\u043e\u0442\u0440\u0430\u0447\u0435\u043d\u043e ${0}. \u041d\u043e\u0432\u044b\u0439 \u0431\u0430\u043b\u0430\u043d\u0441: ${1}", Bridge.box(amount, System.Int32), Bridge.box(this._currentBalance, System.Int32)));
                }
                !Bridge.staticEquals(this.OnBalanceChanged, null) ? this.OnBalanceChanged(this._currentBalance) : null;
                return true;
            },
            /*BalanceManager.SpendMoney end.*/
...
if ( TRACE ) { TRACE( "Build#SpawnBuild", this ); }
    ...
    Bridge.define("BuildManager", {
        ...
        fields: {
            ...
            _buildButton2: null,
            _buildButton3: null,
            _buildButtonObject1: null,
            _buildButtonObject2: null,
            _build1: null,
            _build2: null,
            _build3: null,
...
if ( TRACE ) { TRACE( "BuildManager#OnBuildSuccess", this ); }
                ...
                if (UnityEngine.GameObject.op_Equality(buildObject, this._build1)) {
                    ...
                    this._buildButtonObject1.SetActive(false);
                    UnityEngine.MonoBehaviour.op_Inequality(($t1 = GameManager.Instance), null) ? $t1.DisableTutorial() : null;
                } else if (UnityEngine.GameObject.op_Equality(buildObject, this._build2)) {
                    this._buildButton2.gameObject.SetActive(false);
                    this._buildButtonObject2.SetActive(false);
                    UnityEngine.MonoBehaviour.op_Inequality(($t2 = GameManager.Instance), null) ? $t2.DisableTutorial() : null;
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 4: {
                                    t2 += UnityEngine.Time.deltaTime / this.flashSpeed;
                                        this._material.color = pc.Color.lerp( this._originalColor, this._flashColor, t2 );
                                ...
                                case 9: {
                                    t2 += UnityEngine.Time.deltaTime / this.flashSpeed;
                                        this._material.color = pc.Color.lerp( this._flashColor, this._originalColor, t2 );
                                        $enumerator.current = null;
                                        $step = 10;
                                        return true;
                                }
...
if ( TRACE ) { TRACE( "Character#OnTriggerEnter", this ); }
                ...
                var tree = { };
                if (!this._isFull && other.TryGetComponent$1(Tree, tree)) {
                    tree.v.Take();
...
if ( TRACE ) { TRACE( "Character#UnloadToTruck", this ); }
                ...
                var logsUnloaded = truck.LoadLogs$1(this._currentCargoIndex, Bridge.ensureBaseProperty(this, "gameObject").$UnityEngine$Component$gameObject);
...
if ( TRACE ) { TRACE( "CharactersMover#init", this ); }
                ...
                this._checkTruckAvailabilityInterval = 1.0;
                this._currentPointIndex = 0;
                this._isUnloading = false;
                this._waitingForTruck = false;
                this._visitedDefaultPointBeforeUnload = false;
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "CharactersMover#Start", this ); }
                ...
                if (this._normalRoutePoints != null && this._normalRoutePoints.length !== 0) {
                    this._currentRoute = this._normalRoutePoints;
                }
                this.MoveToNextPoint();
                this.InvokeRepeating("CheckForStuckState", 3.0, 3.0);
            },
...
if ( TRACE ) { TRACE( "CharactersMover#HandleAllTrucksFull", this ); }
                ...
                if (this._waitingForTruck) {
                    this._waitingForTruck = false;
                    this._isUnloading = false;
                    this._currentRoute = System.Array.init([this._defaultUnloadPoint], MovePoint);
                    this._currentPointIndex = 0;
                    DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                    this.MoveToNextPoint();
                }
...
if ( TRACE ) { TRACE( "CharactersMover#HandleRetryUnloading", this ); }
                ...
                if (this._waitingForTruck) {
                    var targetPoint = this.FindNextAvailableUnloadPoint();
                    if (UnityEngine.MonoBehaviour.op_Inequality(targetPoint, null)) {
                        ...
                        this.CancelInvoke$1("HandleRetryUnloading");
...
if ( TRACE ) { TRACE( "CharactersMover#HandleCargoFull", this ); }
                ...
                if (!this._isUnloading && UnityEngine.MonoBehaviour.op_Inequality(this._character, null) && this._character.IsFull) {
...
if ( TRACE ) { TRACE( "CharactersMover#MoveToNextPoint", this ); }
                ...
                if (!pc.Vec3.equals( direction, pc.Vec3.ZERO.clone() )) {
                    var yRotation = new pc.Quat().setLookAt( direction, pc.Vec3.UP ).getPositiveEulerAngles().y;
                    var finalRotation = new pc.Quat().setFromEulerAngles_Unity( this._initialRotationX, yRotation, this._initialRotationZ );
                    DG.Tweening.ShortcutExtensions.DORotateQuaternion(this.transform, finalRotation.$clone(), 0.3);
                }
                if (this._isUnloading && (Bridge.is(currentPoint, UnloadPoint) || UnityEngine.MonoBehaviour.op_Equality(currentPoint, this._defaultUnloadPoint)) && pc.Vec3.distance( this.transform.position, targetPos ) < 0.5) {
                    moveDuration = 0.3;
                }
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, targetPos.$clone(), moveDuration), DG.Tweening.Ease.InOutSine), Bridge.fn.bind(this, function () {
                    this.HandleArrivalAtPoint(currentPoint);
                }));
            },
            /*CharactersMover.MoveToNextPoint end.*/

            /*CharactersMover.HandleArrivalAtPoint start.*/
            HandleArrivalAtPoint: function (currentPoint) {
if ( TRACE ) { TRACE( "CharactersMover#HandleArrivalAtPoint", this ); }

                if (this._isUnloading && UnityEngine.MonoBehaviour.op_Equality(currentPoint, this._defaultUnloadPoint) && !this._visitedDefaultPointBeforeUnload) {
                    this._visitedDefaultPointBeforeUnload = true;
                    if (this._defaultUnloadPoint.CanUnload$1(this._character.gameObject)) {
                        if (this._character.UnloadToTruck(this._defaultUnloadPoint.TargetTruck) === 0 && this._character.CargoCount > 0) {
                            var nextPoint = this.FindNextAvailableUnloadPoint(this._defaultUnloadPoint);
                            if (UnityEngine.MonoBehaviour.op_Inequality(nextPoint, null)) {
                        ...
                        var nextPoint2 = this.FindNextAvailableUnloadPoint(this._defaultUnloadPoint);
                        if (UnityEngine.MonoBehaviour.op_Inequality(nextPoint2, null)) {
                            this._currentRoute = System.Array.init([nextPoint2], MovePoint);
                            this._currentPointIndex = 0;
                            DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                            this.MoveToNextPoint();
                        } else {
                    ...
                    var unloadPoint;
                    if (this._isUnloading && UnityEngine.MonoBehaviour.op_Inequality(((unloadPoint = Bridge.as(currentPoint, UnloadPoint))), null) && UnityEngine.MonoBehaviour.op_Inequality(unloadPoint, this._defaultUnloadPoint)) {
                        this._character.UnloadToTruck(unloadPoint.TargetTruck);
                        this._currentRoute = System.Array.init([this._defaultUnloadPoint], MovePoint);
                        this._currentPointIndex = 0;
                        DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                        this.MoveToNextPoint();
                    } else if (!this._isUnloading && UnityEngine.MonoBehaviour.op_Equality(currentPoint, this._defaultUnloadPoint)) {
                        this._currentRoute = this._normalRoutePoints;
                        this._currentPointIndex = 0;
                        DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                        this.MoveToNextPoint();
                        ...
                        DG.Tweening.DOVirtual.DelayedCall(0.05, Bridge.fn.cacheBind(this, this.MoveToNextPoint));
                    }
                }
            },
            /*CharactersMover.HandleArrivalAtPoint end.*/

            /*CharactersMover.CheckForStuckState start.*/
            CheckForStuckState: function () {
if ( TRACE ) { TRACE( "CharactersMover#CheckForStuckState", this ); }

                if (!this._isUnloading || !(UnityEngine.MonoBehaviour.op_Inequality(this._character, null)) || this._character.CargoCount <= 0) {
                    return;
                }
                if (this._waitingForTruck) {
                    var availablePoint = this.FindNextAvailableUnloadPoint();
                    if (UnityEngine.MonoBehaviour.op_Inequality(availablePoint, null)) {
                        this._waitingForTruck = false;
                        this._currentRoute = System.Array.init([availablePoint], MovePoint);
                        this._currentPointIndex = 0;
                        DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                        this.MoveToNextPoint();
                        return;
                ...
                if (this.IsAtDestination() && this._currentRoute != null && this._currentRoute.length !== 0 && this._currentPointIndex < this._currentRoute.length && Bridge.is(this._currentRoute[this._currentPointIndex], UnloadPoint)) {
                    var currentPoint = Bridge.as(this._currentRoute[this._currentPointIndex], UnloadPoint);
                    var availablePoint2 = this.FindNextAvailableUnloadPoint(currentPoint);
                    if (UnityEngine.MonoBehaviour.op_Inequality(availablePoint2, null)) {
                        this._currentRoute = System.Array.init([availablePoint2], MovePoint);
                        this._currentPointIndex = 0;
                        DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                        this.MoveToNextPoint();
                        return;
                ...
                if (!this._visitedDefaultPointBeforeUnload) {
                    var movingToDefaultPoint = false;
                    if (this._currentRoute != null && this._currentRoute.length !== 0 && this._currentPointIndex < this._currentRoute.length) {
                        movingToDefaultPoint = UnityEngine.MonoBehaviour.op_Equality(this._currentRoute[this._currentPointIndex], this._defaultUnloadPoint);
                    }
                    if (movingToDefaultPoint) {
                        return;
                    }
                }
                var anyAvailablePoint = this.FindNextAvailableUnloadPoint();
                if (UnityEngine.MonoBehaviour.op_Inequality(anyAvailablePoint, null) && (!this.IsAtDestination() || this._waitingForTruck)) {
                    this._waitingForTruck = false;
                    this._currentRoute = System.Array.init([anyAvailablePoint], MovePoint);
                    this._currentPointIndex = 0;
                    DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                    this.MoveToNextPoint();
                }
            },
            /*CharactersMover.CheckForStuckState end.*/

            /*CharactersMover.IsAtDestination start.*/
            IsAtDestination: function () {
if ( TRACE ) { TRACE( "CharactersMover#IsAtDestination", this ); }

                if (this._currentRoute == null || this._currentRoute.length === 0 || this._currentPointIndex >= this._currentRoute.length) {
                    return false;
                }
                var currentTarget = this._currentRoute[this._currentPointIndex];
                return pc.Vec3.distance( this.transform.position, currentTarget.transform.position ) < 0.2;
            },
            /*CharactersMover.IsAtDestination end.*/
...
if ( TRACE ) { TRACE( "CharactersMover#FindNextAvailableUnloadPoint", this ); }
                ...
                var $t;
                if (currentPoint === void 0) { currentPoint = null; }
                var unloadPoints = this._unloadPoints;
                $t = Bridge.getEnumerator(unloadPoints);
                try {
                    while ($t.moveNext()) {
                        var point = $t.Current;
                        if (UnityEngine.MonoBehaviour.op_Inequality(point, currentPoint) && UnityEngine.MonoBehaviour.op_Inequality(point.TargetTruck, null) && point.CanUnload$1(this._character.gameObject)) {
                            return point;
                        }
                    }
                } finally {
...
if ( TRACE ) { TRACE( "ChopperManager#GetTargetTruck", this ); }
                ...
                var availableTruck = UnityEngine.MonoBehaviour.op_Inequality(($t = TruckManager.Instance), null) ? $t.GetAvailableTruck() : null;
                if (UnityEngine.MonoBehaviour.op_Inequality(availableTruck, null)) {
                    this._targetTruck = availableTruck;
                    this._isTargetTruckSelected = true;
...
if ( TRACE ) { TRACE( "Conveyor#Start", this ); }
                ...
                this.StartCoroutine$1(this.StartAnimationAfterDelay(8.0, "Conveyor2"));
                this.StartCoroutine$1(this.StartAnimationAfterDelay(25.0, "Conveyor3"));
            },
            /*Conveyor.Start end.*/
...
if ( TRACE ) { TRACE( "GameManager#Awake", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Inequality(this.secondRequiredButton, null)) {
                    this.secondRequiredButton.interactable = false;
...
if ( TRACE ) { TRACE( "GameManager#ResetIdleTimer", this ); }
                ...
                if (this.idleCoroutine != null) {
                    this.StopCoroutine$2(this.idleCoroutine);
                }
                this.StartIdleCoroutine();
            },
            /*GameManager.ResetIdleTimer end.*/

            /*GameManager.StartIdleCoroutine start.*/
            StartIdleCoroutine: function () {
if ( TRACE ) { TRACE( "GameManager#StartIdleCoroutine", this ); }

                this.idleCoroutine = this.StartCoroutine$1(this.IdleCoroutine());
            },
            /*GameManager.StartIdleCoroutine end.*/

            /*GameManager.IdleCoroutine start.*/
            IdleCoroutine: function () {
if ( TRACE ) { TRACE( "GameManager#IdleCoroutine", this ); }
...
if ( TRACE ) { TRACE( "GameManager#ShowSecondTutorial", this ); }
            ...
            /*GameManager.Tutorial2Coroutine start.*/
            Tutorial2Coroutine: function () {
if ( TRACE ) { TRACE( "GameManager#Tutorial2Coroutine", this ); }
...
if ( TRACE ) { TRACE( "GameManager#CheckBalanceThresholds", this ); }
                ...
                if (newBalance >= 20 && !this.tutorial2Shown && !this.secondBuildingActive && !this.thirdBuildingActive) {
                    ...
                    this.tutorial2Coroutine = this.StartCoroutine$1(this.Tutorial2Coroutine());
                }
                if (newBalance >= 100 && !this.upgradeButtonEnabled) {
                    this.EnableUpgradeButton();
                }
                if (newBalance >= 100 && UnityEngine.MonoBehaviour.op_Inequality(this.secondRequiredButton, null)) {
                    this.secondRequiredButton.interactable = true;
                }
            },
...
if ( TRACE ) { TRACE( "GameManager#OnUpgradeButtonClicked", this ); }
                ...
                if (this.packShotCoroutine != null) {
                    this.StopCoroutine$2(this.packShotCoroutine);
                }
                this.StartPackShotCoroutine();
            },
...
if ( TRACE ) { TRACE( "GameManager#OnSecondButtonClicked", this ); }
            ...
            /*GameManager.StartPackShotCoroutine start.*/
            StartPackShotCoroutine: function () {
if ( TRACE ) { TRACE( "GameManager#StartPackShotCoroutine", this ); }

                this.packShotCoroutine = this.StartCoroutine$1(this.PackShotIdleCoroutine());
            },
            /*GameManager.StartPackShotCoroutine end.*/

            /*GameManager.PackShotIdleCoroutine start.*/
            PackShotIdleCoroutine: function () {
if ( TRACE ) { TRACE( "GameManager#PackShotIdleCoroutine", this ); }
            ...
            /*GameManager.PackShotIdleCoroutine end.*/
...
if ( TRACE ) { TRACE( "GameManager#CheckPackShotActivation", this ); }
            ...
            /*GameManager.DisableTutorial start.*/
            DisableTutorial: function () {
if ( TRACE ) { TRACE( "GameManager#DisableTutorial", this ); }

                if (UnityEngine.GameObject.op_Inequality(this.tutorialObject, null)) {
                    this.tutorialObject.SetActive(false);
                }
            },
            /*GameManager.DisableTutorial end.*/
...
if ( TRACE ) { TRACE( "MoneyBalance#SetMoney", this ); }
                ...
                this.StartCoroutine$1(this.AnimateMoneyChange(((this._money + money) | 0)));
            },
...
if ( TRACE ) { TRACE( "MoneyController#TryBuild", this ); }
                ...
                if (this._moneyBalance.Money >= price) {
                    UnityEngine.MonoBehaviour.op_Inequality(this._moneyFlyAnimation, null) ? this._moneyFlyAnimation.FlyCoinsFromUIToWorld(buildObject.transform.position.$clone()) : null;
                    this._moneyBalance.TakeMoney(price);
                    this.StartCoroutine$1(this.ActivateBuildWithDelay(buildObject, 1.0));
                }
            },
            /*MoneyController.TryBuild end.*/

            /*MoneyController.ActivateBuildWithDelay start.*/
            ActivateBuildWithDelay: function (buildObject, delay) {
if ( TRACE ) { TRACE( "MoneyController#ActivateBuildWithDelay", this ); }
            ...
            /*MoneyController.ActivateBuildWithDelay end.*/
...
if ( TRACE ) { TRACE( "MoneyFlyAnimation#FlyCoins", this ); }
                ...
                if (UnityEngine.Component.op_Equality(this.worldStartPoint, null) || UnityEngine.Component.op_Equality(this.uiTargetPoint, null)) {
                    ...
                    this.StartCoroutine$1(this.FlyCoinsFromWorldToUI(this.worldStartPoint.position.$clone(), this.uiTargetPoint));
                }
            },
...
if ( TRACE ) { TRACE( "MoneyFlyAnimation#FlyCoinsFromUIToWorld", this ); }
                ...
                if (UnityEngine.Component.op_Equality(this.uiTargetPoint, null)) {
                    ...
                    this.StartCoroutine$1(this.FlyCoinsFromUIToWorldCoroutine(this.uiTargetPoint, worldTarget.$clone()));
                }
            },
...
if ( TRACE ) { TRACE( "MoneyFlyAnimation#GetCoinFromPool", this ); }
    ...
    Bridge.define("SimpleAudioManager", {
        ...
        statics: {
            fields: {
                INITIAL_SOUND_DELAY: 0,
                Instance: null
            },
            ctors: {
                init: function () {
if ( TRACE ) { TRACE( "SimpleAudioManager#init", this ); }

                    this.INITIAL_SOUND_DELAY = 2.0;
                }
            }
        },
        fields: {
...
if ( TRACE ) { TRACE( "SimpleAudioManager#Awake", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Equality(SimpleAudioManager.Instance, null)) {
                    ...
                    UnityEngine.Object.DontDestroyOnLoad(Bridge.ensureBaseProperty(this, "gameObject").$UnityEngine$Component$gameObject);
                    this.audioSource = Bridge.ensureBaseProperty(this, "gameObject").$UnityEngine$Component$gameObject.AddComponent(UnityEngine.AudioSource);
                    this.gameStartTime = UnityEngine.Time.time;
                } else {
                    UnityEngine.Object.Destroy(Bridge.ensureBaseProperty(this, "gameObject").$UnityEngine$Component$gameObject);
                }
            },
            ...
            /*SimpleAudioManager.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "SimpleAudioManager#Update", this ); }

                if (!this.soundsEnabled && UnityEngine.Time.time - this.gameStartTime >= 2.0) {
                    this.soundsEnabled = true;
                    UnityEngine.Debug.Log$1("\u0417\u0432\u0443\u043a\u0438 \u0432\u043a\u043b\u044e\u0447\u0435\u043d\u044b \u043f\u043e\u0441\u043b\u0435 \u043d\u0430\u0447\u0430\u043b\u044c\u043d\u043e\u0439 \u0437\u0430\u0434\u0435\u0440\u0436\u043a\u0438");
                }
            },
            /*SimpleAudioManager.Update end.*/
...
if ( TRACE ) { TRACE( "SimpleAudioManager#PlaySound", this ); }
                ...
                if (clip != null && this.soundsEnabled) {
...
if ( TRACE ) { TRACE( "Tree#Start", this ); }
            ...
            /*Tree.OnTriggerEnter start.*/
            OnTriggerEnter: function (other) {
if ( TRACE ) { TRACE( "Tree#OnTriggerEnter", this ); }

                if (UnityEngine.MonoBehaviour.op_Inequality(other.gameObject.GetComponent(Wall), null)) {
                    this.transform.SetParent(null);
                }
            },
            /*Tree.OnTriggerEnter end.*/
...
if ( TRACE ) { TRACE( "Truck#LoadLogs$1", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Inequality(loader.GetComponent(Forklift), null) && this._isBeingLoadedByChopper) {
                    return 0;
                }
                if (isChopper) {
...
if ( TRACE ) { TRACE( "Truck#Clear", this ); }
            ...
            /*Truck.SetAtUnloadPoint start.*/
            SetAtUnloadPoint: function (isAtUnloadPoint) {
if ( TRACE ) { TRACE( "Truck#SetAtUnloadPoint", this ); }

                this.IsAtUnloadPoint = isAtUnloadPoint;
            },
            /*Truck.SetAtUnloadPoint end.*/
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        if (UnityEngine.MonoBehaviour.op_Equality(truck.v.GetComponent(TruckMover), null)) {
                            UnityEngine.Debug.LogWarning$1("Truck " + (truck.v.name || "") + " does not have a TruckMover component. Auto-unloading will not work for this truck.");
                        }
...
if ( TRACE ) { TRACE( "TruckMover#Awake", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Inequality(TruckManager.Instance, null)) {
                    var instance = TruckManager.Instance;
                    instance.OnTruckReadyToSend = Bridge.fn.combine(instance.OnTruckReadyToSend, Bridge.fn.cacheBind(this, this.HandleTruckReadyToSend));
                }
...
if ( TRACE ) { TRACE( "TruckMover#OnDestroy", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Inequality(TruckManager.Instance, null)) {
                    var instance = TruckManager.Instance;
                    instance.OnTruckReadyToSend = Bridge.fn.remove(instance.OnTruckReadyToSend, Bridge.fn.cacheBind(this, this.HandleTruckReadyToSend));
                }
                DG.Tweening.ShortcutExtensions.DOKill(this.transform);
            },
                            ...
                            switch ($step) {
                                case 0: {
                                    this._isMoving = true;
                                        ...
                                        moveTween2 = DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, targetPosition.$clone(), this._moveDuration), this._moveEase);
                                        $enumerator.current = DG.Tweening.TweenExtensions.WaitForCompletion(moveTween2);
                                        $step = 1;
                                        return true;
                                }
                                case 1: {
                                    this._truck.SetAtUnloadPoint(true);
                                        $enumerator.current = this.StartCoroutine$1(this.UnloadTruckRoutine());
                                        $step = 2;
                                        return true;
                                }
                                case 2: {
                                    this._truck.SetAtUnloadPoint(false);
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    wasFull = true;
                                        Bridge["Bridge._"] = Bridge.box((this._truck.MaxCapacity - this._truck.RemainingCapacity) | 0, System.Int32);
                                        this._truck.Clear();
                                        if (wasFull) {
                                            moneyController = MoneyController.Instance;
                                            if (UnityEngine.MonoBehaviour.op_Inequality(moneyController, null)) {
                                                reward = 20;
                                                moneyController.ChangeBalanceWithVisual$1(reward, this.transform.position.$clone());
                                            }
                                        }
...
if ( TRACE ) { TRACE( "TruckProgressBarSetup#init", this ); }
                ...
                this._offsetPosition = new pc.Vec3( 0.0, 2.5, 0.0 );
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "TruckProgressBarSetup#AssignProgressBar", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Inequality(progressBarImage, null)) {
                    ...
                    UnityEngine.Debug.LogWarning$1("\u041f\u0440\u043e\u0433\u0440\u0435\u0441\u0441 \u0431\u0430\u0440 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d \u0434\u043b\u044f \u0433\u0440\u0443\u0437\u043e\u0432\u0438\u043a\u0430 " + (truck.name || "") + ".");
                }
            },
...
if ( TRACE ) { TRACE( "UnloadPoint#CanUnload", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Equality(this._targetTruck, null) || !this._targetTruck.IsAtUnloadPoint) {
                    return false;
                }
                ...
                return this._targetTruck.RemainingCapacity > 0 && !truckMoving;
            },
...
if ( TRACE ) { TRACE( "UnloadPoint#CanUnload$1", this ); }
                ...
                if (isForklift && this._targetTruck.CurrentCargoCount > 0 && !this._allowForkliftToLoadHalfFullTrucks) {
                    return false;
                }
                return canUnload;
            },
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","UnityEngine.UI","System.Collections","System.Collections.Generic","TMPro","DG.Tweening","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];

    /*AdaptiveCameraPosition start.*/
    $m("AdaptiveCameraPosition", function () { return {"nested":[AdaptiveCameraPosition.CameraSettings],"att":1048577,"a":2,"at":[new UnityEngine.RequireComponent.ctor(UnityEngine.Camera)],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"ForceUpdate","t":8,"sn":"ForceUpdate","rt":$n[0].Void},{"a":1,"n":"GetIsPortrait","t":8,"sn":"GetIsPortrait","rt":$n[0].Boolean,"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"UpdateCameraMode","t":8,"pi":[{"n":"isPortrait","pt":$n[0].Boolean,"ps":0}],"sn":"UpdateCameraMode","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":1,"n":"_camera","t":4,"rt":$n[1].Camera,"sn":"_camera"},{"a":1,"n":"_isPortrait","t":4,"rt":$n[0].Boolean,"sn":"_isPortrait","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"_isTransitioning","t":4,"rt":$n[0].Boolean,"sn":"_isTransitioning","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"_lastOrientation","t":4,"rt":$n[1].ScreenOrientation,"sn":"_lastOrientation","box":function ($v) { return Bridge.box($v, UnityEngine.ScreenOrientation, System.Enum.toStringFn(UnityEngine.ScreenOrientation));}},{"a":1,"n":"_targetFOV","t":4,"rt":$n[0].Single,"sn":"_targetFOV","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_targetOrthoSize","t":4,"rt":$n[0].Single,"sn":"_targetOrthoSize","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_targetPosition","t":4,"rt":$n[1].Vector3,"sn":"_targetPosition"},{"a":1,"n":"_targetRotation","t":4,"rt":$n[1].Quaternion,"sn":"_targetRotation"},{"at":[new UnityEngine.TooltipAttribute("\u041f\u043e\u0440\u043e\u0433 \u0441\u043e\u043e\u0442\u043d\u043e\u0448\u0435\u043d\u0438\u044f \u0441\u0442\u043e\u0440\u043e\u043d \u0434\u043b\u044f \u043e\u043f\u0440\u0435\u0434\u0435\u043b\u0435\u043d\u0438\u044f \u043e\u0440\u0438\u0435\u043d\u0442\u0430\u0446\u0438\u0438 (portrait < threshold < landscape)")],"a":2,"n":"aspectRatioThreshold","t":4,"rt":$n[0].Single,"sn":"aspectRatioThreshold","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.TooltipAttribute("\u0412\u043a\u043b\u044e\u0447\u0438\u0442\u044c \u0440\u0435\u0436\u0438\u043c \u043e\u0442\u043b\u0430\u0434\u043a\u0438")],"a":2,"n":"debugMode","t":4,"rt":$n[0].Boolean,"sn":"debugMode","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.TooltipAttribute("\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u043a\u0430\u043c\u0435\u0440\u044b \u0434\u043b\u044f \u0433\u043e\u0440\u0438\u0437\u043e\u043d\u0442\u0430\u043b\u044c\u043d\u043e\u0433\u043e \u0440\u0435\u0436\u0438\u043c\u0430")],"a":2,"n":"landscapeSettings","t":4,"rt":AdaptiveCameraPosition.CameraSettings,"sn":"landscapeSettings"},{"at":[new UnityEngine.HeaderAttribute("\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u043e\u0440\u0438\u0435\u043d\u0442\u0430\u0446\u0438\u0438"),new UnityEngine.TooltipAttribute("\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u043a\u0430\u043c\u0435\u0440\u044b \u0434\u043b\u044f \u043f\u043e\u0440\u0442\u0440\u0435\u0442\u043d\u043e\u0433\u043e \u0440\u0435\u0436\u0438\u043c\u0430")],"a":2,"n":"portraitSettings","t":4,"rt":AdaptiveCameraPosition.CameraSettings,"sn":"portraitSettings"},{"at":[new UnityEngine.HeaderAttribute("\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0435 \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438"),new UnityEngine.TooltipAttribute("\u0421\u043a\u043e\u0440\u043e\u0441\u0442\u044c \u043f\u0435\u0440\u0435\u043c\u0435\u0449\u0435\u043d\u0438\u044f \u043a\u0430\u043c\u0435\u0440\u044b \u043f\u0440\u0438 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0438 \u043e\u0440\u0438\u0435\u043d\u0442\u0430\u0446\u0438\u0438")],"a":2,"n":"transitionSpeed","t":4,"rt":$n[0].Single,"sn":"transitionSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*AdaptiveCameraPosition end.*/

    /*AdaptiveCameraPosition+CameraSettings start.*/
    $m("AdaptiveCameraPosition.CameraSettings", function () { return {"td":AdaptiveCameraPosition,"att":1056770,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"fieldOfView","t":4,"rt":$n[0].Single,"sn":"fieldOfView","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"orthographicSize","t":4,"rt":$n[0].Single,"sn":"orthographicSize","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"position","t":4,"rt":$n[1].Vector3,"sn":"position"},{"a":2,"n":"rotation","t":4,"rt":$n[1].Vector3,"sn":"rotation"}]}; }, $n);
    /*AdaptiveCameraPosition+CameraSettings end.*/

    /*BalanceManager start.*/
    $m("BalanceManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"AddMoney","t":8,"pi":[{"n":"amount","pt":$n[0].Int32,"ps":0}],"sn":"AddMoney","rt":$n[0].Int32,"p":[$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"SpendMoney","t":8,"pi":[{"n":"amount","pt":$n[0].Int32,"ps":0}],"sn":"SpendMoney","rt":$n[0].Boolean,"p":[$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"CurrentBalance","t":16,"rt":$n[0].Int32,"g":{"a":2,"n":"get_CurrentBalance","t":8,"rt":$n[0].Int32,"fg":"CurrentBalance","box":function ($v) { return Bridge.box($v, System.Int32);}},"fn":"CurrentBalance"},{"a":2,"n":"Instance","is":true,"t":16,"rt":BalanceManager,"g":{"a":2,"n":"get_Instance","t":8,"rt":BalanceManager,"fg":"Instance","is":true},"s":{"a":1,"n":"set_Instance","t":8,"p":[BalanceManager],"rt":$n[0].Void,"fs":"Instance","is":true},"fn":"Instance"},{"a":1,"n":"_currentBalance","t":4,"rt":$n[0].Int32,"sn":"_currentBalance","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_debugLogs","t":4,"rt":$n[0].Boolean,"sn":"_debugLogs","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_initialBalance","t":4,"rt":$n[0].Int32,"sn":"_initialBalance","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"OnBalanceChanged","t":2,"ad":{"a":2,"n":"add_OnBalanceChanged","t":8,"pi":[{"n":"value","pt":Function,"ps":0}],"sn":"addOnBalanceChanged","rt":$n[0].Void,"p":[Function]},"r":{"a":2,"n":"remove_OnBalanceChanged","t":8,"pi":[{"n":"value","pt":Function,"ps":0}],"sn":"removeOnBalanceChanged","rt":$n[0].Void,"p":[Function]}},{"a":1,"backing":true,"n":"<Instance>k__BackingField","is":true,"t":4,"rt":BalanceManager,"sn":"Instance"}]}; }, $n);
    /*BalanceManager end.*/
    ...
    /*ChopperManager start.*/
    $m("ChopperManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"GetTargetTruck","t":8,"sn":"GetTargetTruck","rt":Truck},{"a":2,"n":"IsTargetTruck","t":8,"pi":[{"n":"truck","pt":Truck,"ps":0}],"sn":"IsTargetTruck","rt":$n[0].Boolean,"p":[Truck],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"ResetTargetTruck","t":8,"sn":"ResetTargetTruck","rt":$n[0].Void},{"a":2,"n":"Instance","is":true,"t":16,"rt":ChopperManager,"g":{"a":2,"n":"get_Instance","t":8,"rt":ChopperManager,"fg":"Instance","is":true},"s":{"a":1,"n":"set_Instance","t":8,"p":[ChopperManager],"rt":$n[0].Void,"fs":"Instance","is":true},"fn":"Instance"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_choppers","t":4,"rt":$n[4].List$1(Chopper),"sn":"_choppers"},{"a":1,"n":"_isTargetTruckSelected","t":4,"rt":$n[0].Boolean,"sn":"_isTargetTruckSelected","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"_targetTruck","t":4,"rt":Truck,"sn":"_targetTruck"},{"a":1,"backing":true,"n":"<Instance>k__BackingField","is":true,"t":4,"rt":ChopperManager,"sn":"Instance"}]}; }, $n);
    /*ChopperManager end.*/
    ...
    /*SimpleAudioManager start.*/
    $m("SimpleAudioManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"PlayButtonClickSound","t":8,"sn":"PlayButtonClickSound","rt":$n[0].Void},{"a":2,"n":"PlayConveyorAnimationSound","t":8,"sn":"PlayConveyorAnimationSound","rt":$n[0].Void},{"a":2,"n":"PlayHouseAppearSound","t":8,"sn":"PlayHouseAppearSound","rt":$n[0].Void},{"a":2,"n":"PlayLogLoadSound","t":8,"sn":"PlayLogLoadSound","rt":$n[0].Void},{"a":2,"n":"PlayProgressBarSound","t":8,"sn":"PlayProgressBarSound","rt":$n[0].Void},{"a":1,"n":"PlaySound","t":8,"pi":[{"n":"clip","pt":$n[1].AudioClip,"ps":0}],"sn":"PlaySound","rt":$n[0].Void,"p":[$n[1].AudioClip]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"Instance","is":true,"t":16,"rt":SimpleAudioManager,"g":{"a":2,"n":"get_Instance","t":8,"rt":SimpleAudioManager,"fg":"Instance","is":true},"s":{"a":1,"n":"set_Instance","t":8,"p":[SimpleAudioManager],"rt":$n[0].Void,"fs":"Instance","is":true},"fn":"Instance"},{"a":1,"n":"INITIAL_SOUND_DELAY","is":true,"t":4,"rt":$n[0].Single,"sn":"INITIAL_SOUND_DELAY","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"audioSource","t":4,"rt":$n[1].AudioSource,"sn":"audioSource"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"buttonClickSound","t":4,"rt":$n[1].AudioClip,"sn":"buttonClickSound"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"conveyorAnimationSound","t":4,"rt":$n[1].AudioClip,"sn":"conveyorAnimationSound"},{"a":1,"n":"gameStartTime","t":4,"rt":$n[0].Single,"sn":"gameStartTime","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"houseAppearSound","t":4,"rt":$n[1].AudioClip,"sn":"houseAppearSound"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"logLoadSound","t":4,"rt":$n[1].AudioClip,"sn":"logLoadSound"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"progressBarSound","t":4,"rt":$n[1].AudioClip,"sn":"progressBarSound"},{"a":1,"n":"soundsEnabled","t":4,"rt":$n[0].Boolean,"sn":"soundsEnabled","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"backing":true,"n":"<Instance>k__BackingField","is":true,"t":4,"rt":SimpleAudioManager,"sn":"Instance"}]}; }, $n);
    /*SimpleAudioManager end.*/
