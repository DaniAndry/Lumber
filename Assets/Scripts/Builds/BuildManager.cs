...
{
    [SerializeField] public Button _buildButton1;
    [SerializeField] public Button _buildButton2;
    [SerializeField] public Button _buildButton3;
    [SerializeField] public GameObject _buildButtonObject1;
    [SerializeField] public GameObject _buildButtonObject2;

    [SerializeField] public GameObject _build1;
    [SerializeField] public GameObject _build2;
    [SerializeField] public GameObject _build3;
    ...
    public int GetConstructedBuildingsCount()
    {
        ...
        // Проверяем активные здания по отсутствию соответствующих кнопок
